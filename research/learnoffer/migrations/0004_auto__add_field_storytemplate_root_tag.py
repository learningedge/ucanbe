...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoryTemplate.root_tag'
        db.add_column('learnoffer_storytemplate', 'root_tag', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='story_templates', to=orm['learnoffer.AssociationTag']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoryTemplate.root_tag'
        db.delete_column('learnoffer_storytemplate', 'root_tag_id')
